...
void DungeonStompApp::ProcessLights11()
{
	...
	for (int i = 0; i < dcount; i++)
	{
		...
		LightContainer[i].Strength = { 1.0f, 1.0f, 1.0f };
		LightContainer[i].Position = DirectX::XMFLOAT3{ oblist[q].x,oblist[q].y + 45.0f, oblist[q].z };
	}
